...
#### Test Actor Example Included with Plugin:
<img width="478" height="204" alt="Test Actor Example" src="https://github.com/user-attachments/assets/de9ba61b-ae5f-4b55-af0a-b9f580cfcf96" />

#### Blueprint Implementation inside Actor:
<img width="1917" height="937" alt="Blueprint Code" src="https://github.com/user-attachments/assets/f4b1409b-7565-45f7-a278-e7a4c0fb5d61" />

#### C++ Execution Example:
```cpp
// Execute rewind on component reference
